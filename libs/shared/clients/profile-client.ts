...
export class MasterDataClient {
     ...
     * @return OK
     */
    getCountries(): Promise<MasterDataOptionDto[]> {
        let url_ = this.baseUrl + "/api/master-data/countries";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetCountries(response: Response): Promise<MasterDataOptionDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getIncomeRanges(): Promise<MasterDataOptionDto[]> {
        let url_ = this.baseUrl + "/api/master-data/income-ranges";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetIncomeRanges(_response);
        });
    }

    protected processGetIncomeRanges(response: Response): Promise<MasterDataOptionDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class UserProfilesClient {
     ...
     * @param occupationId (optional) 
     * @param workingCity (optional) 
     * @param nativePlace (optional) 
     * @param nativeDistrictId (optional) 
     * @param city (optional) 
     * @param stateId (optional) 
     * @param countryId (optional) 
     * @param heightFromFt (optional) 
     * @param heightFromIn (optional) 
     * @param heightToFt (optional) 
     * @param heightToIn (optional) 
     * @param annualIncomeFrom (optional) 
     * @param annualIncomeTo (optional) 
     * @param isVerified (optional) 
     * @param excludeUserId (optional) 
     ...
     * @return OK
     */
    searchPublic(tenantId: number | undefined, genderId: number | undefined, ageFrom: number | undefined, ageTo: number | undefined, religionId: number | undefined, casteId: number | undefined, maritalStatusId: number | undefined, educationId: number | undefined, occupationId: number | undefined, workingCity: string | undefined, nativePlace: string | undefined, nativeDistrictId: number | undefined, city: string | undefined, stateId: number | undefined, countryId: number | undefined, heightFromFt: number | undefined, heightFromIn: number | undefined, heightToFt: number | undefined, heightToIn: number | undefined, annualIncomeFrom: number | undefined, annualIncomeTo: number | undefined, isVerified: boolean | undefined, excludeUserId: number | undefined, pageNumber: number | undefined, pageSize: number | undefined, searchTerm: string | undefined, sortBy: string | undefined, sortDescending: boolean | undefined): Promise<ProfileListItemDtoPagedResult> {
        ...
        if (occupationId === null)
            throw new globalThis.Error("The parameter 'occupationId' cannot be null.");
        else if (occupationId !== undefined)
            url_ += "OccupationId=" + encodeURIComponent("" + occupationId) + "&";
        if (workingCity === null)
            throw new globalThis.Error("The parameter 'workingCity' cannot be null.");
        else if (workingCity !== undefined)
            url_ += "WorkingCity=" + encodeURIComponent("" + workingCity) + "&";
        if (nativePlace === null)
            throw new globalThis.Error("The parameter 'nativePlace' cannot be null.");
        else if (nativePlace !== undefined)
            url_ += "NativePlace=" + encodeURIComponent("" + nativePlace) + "&";
        if (nativeDistrictId === null)
            throw new globalThis.Error("The parameter 'nativeDistrictId' cannot be null.");
        else if (nativeDistrictId !== undefined)
            url_ += "NativeDistrictId=" + encodeURIComponent("" + nativeDistrictId) + "&";
        if (city === null)
        ...
        if (heightFromIn === null)
            throw new globalThis.Error("The parameter 'heightFromIn' cannot be null.");
        else if (heightFromIn !== undefined)
            url_ += "HeightFromIn=" + encodeURIComponent("" + heightFromIn) + "&";
        if (heightToFt === null)
        ...
        if (heightToIn === null)
            throw new globalThis.Error("The parameter 'heightToIn' cannot be null.");
        else if (heightToIn !== undefined)
            url_ += "HeightToIn=" + encodeURIComponent("" + heightToIn) + "&";
        ...
        if (excludeUserId === null)
            throw new globalThis.Error("The parameter 'excludeUserId' cannot be null.");
        else if (excludeUserId !== undefined)
            url_ += "ExcludeUserId=" + encodeURIComponent("" + excludeUserId) + "&";
        if (pageNumber === null)
     ...
     * @return OK
     */
    getStats(): Promise<ProfileStatsDto> {
        let url_ = this.baseUrl + "/api/UserProfiles/stats";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetStats(response: Response): Promise<ProfileStatsDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ProfileStatsDto.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<ProfileStatsDto>(null as any);
    }
     ...
     * @return OK
     */
    getMyProfile(): Promise<ProfileDetailDto> {
    ...
    protected processGetMyProfile(response: Response): Promise<ProfileDetailDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    updateMyProfile(body: CreateProfileDto | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/UserProfiles/my";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    uploadPhoto(id: number, file: FileParameter | undefined, slot: number | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/UserProfiles/{id}/photos";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        if (slot === null || slot === undefined)
            throw new globalThis.Error("The parameter 'slot' cannot be null.");
        else
            content_.append("Slot", slot.toString());
    ...
    protected processUploadPhoto(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    uploadMyPhoto(file: FileParameter | undefined, slot: number | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/UserProfiles/my/photos";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUploadMyPhoto(_response);
        });
    }

    protected processUploadMyPhoto(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    deletePhoto(id: number, slot: number): Promise<void> {
        let url_ = this.baseUrl + "/api/UserProfiles/{id}/photos/{slot}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        if (slot === undefined || slot === null)
            throw new globalThis.Error("The parameter 'slot' must be defined.");
        url_ = url_.replace("{slot}", encodeURIComponent("" + slot));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processDeletePhoto(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class CareerDetailsViewDto implements ICareerDetailsViewDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.incomeAmount = _data["incomeAmount"];
            this.incomePeriodId = _data["incomePeriodId"];
            this.educationAreaName = _data["educationAreaName"];
            ...
            this.workingStateName = _data["workingStateName"];
...
export class FamilyDetailsDto implements IFamilyDetailsDto {
    ...
    nativeTalukaName?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.nativeTalukaName = _data["nativeTalukaName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["nativeTalukaName"] = this.nativeTalukaName;
        return data;
    }
}
...
export class PersonalDetailsViewDto implements IPersonalDetailsViewDto {
    ...
    subCasteName?: string | undefined;
    maritalStatusName?: string | undefined;
    bloodGroupName?: string | undefined;
    complexionName?: string | undefined;
    dietName?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.subCasteName = _data["subCasteName"];
            this.maritalStatusName = _data["maritalStatusName"];
            this.bloodGroupName = _data["bloodGroupName"];
            this.complexionName = _data["complexionName"];
            this.dietName = _data["dietName"];
            this.personalityName = _data["personalityName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["complexionName"] = this.complexionName;
        data["dietName"] = this.dietName;
        data["personalityName"] = this.personalityName;
        return data;
    }
}
...
export class ProfileHoroscopeDetailDto implements IProfileHoroscopeDetailDto {
    ...
    rashiName?: string | undefined;
    nakshatraName?: string | undefined;
    charanName?: string | undefined;
    nadiName?: string | undefined;
    ganName?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.rashiName = _data["rashiName"];
            this.nakshatraName = _data["nakshatraName"];
            this.charanName = _data["charanName"];
            this.nadiName = _data["nadiName"];
            this.ganName = _data["ganName"];
    ...
    toJSON(data?: any) {
        ...
        data["rashiName"] = this.rashiName;
        data["nakshatraName"] = this.nakshatraName;
        data["charanName"] = this.charanName;
        data["nadiName"] = this.nadiName;
        data["ganName"] = this.ganName;
...
export class ProfileListItemDto implements IProfileListItemDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.publicDisplayName = _data["publicDisplayName"];
...
export class ProfileStatsDto implements IProfileStatsDto {
    ...
    constructor(data?: IProfileStatsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.totalProfiles = _data["totalProfiles"];
            this.brideCount = _data["brideCount"];
            this.groomCount = _data["groomCount"];
            this.unmarriedCount = _data["unmarriedCount"];
            this.divorcedCount = _data["divorcedCount"];
        }
    }

    static fromJS(data: any): ProfileStatsDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProfileStatsDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["brideCount"] = this.brideCount;
        data["groomCount"] = this.groomCount;
        data["unmarriedCount"] = this.unmarriedCount;
        data["divorcedCount"] = this.divorcedCount;
        return data;
    }
}

export interface IProfileStatsDto {
    totalProfiles?: number;
    brideCount?: number;
    groomCount?: number;
    unmarriedCount?: number;
