...
export class WebhookClient {
     ...
     * @return OK
     */
    receiveWebhook(paymentGatewayId: number): Promise<void> {
        let url_ = this.baseUrl + "/api/webhooks/{paymentGatewayId}";
        if (paymentGatewayId === undefined || paymentGatewayId === null)
            throw new globalThis.Error("The parameter 'paymentGatewayId' must be defined.");
    ...
    protected processReceiveWebhook(response: Response): Promise<void> {
