...
@Injectable()
export class PlatformAdminsClient {
    ...
    getAll(): Observable<PlatformAdminDto[]> {
        let url_ = this.baseUrl + "/api/PlatformAdmins";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PlatformAdminDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PlatformAdminDto[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PlatformAdminDto[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(PlatformAdminDto.fromJS(item));
            }
            else {
        ...
        return _observableOf<PlatformAdminDto[]>(null as any);
    }
     ...
     * @return OK
     */
    create(body: CreatePlatformAdminRequest | undefined): Observable<PlatformAdminDetailDto> {
        let url_ = this.baseUrl + "/api/PlatformAdmins";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PlatformAdminDetailDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PlatformAdminDetailDto>;
        }));
    }

    protected processCreate(response: HttpResponseBase): Observable<PlatformAdminDetailDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PlatformAdminDetailDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PlatformAdminDetailDto>(null as any);
    }
    ...
    getById(id: number): Observable<PlatformAdminDetailDto> {
        let url_ = this.baseUrl + "/api/PlatformAdmins/{id}";
    ...
    protected processGetById(response: HttpResponseBase): Observable<PlatformAdminDetailDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(id: number, body: UpdatePlatformAdminRequest | undefined): Observable<PlatformAdminDetailDto> {
        let url_ = this.baseUrl + "/api/PlatformAdmins/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processUpdate(response: HttpResponseBase): Observable<PlatformAdminDetailDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class PlatformRolesClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(): Observable<PlatformRoleDto[]> {
        let url_ = this.baseUrl + "/api/PlatformRoles";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PlatformRoleDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PlatformRoleDto[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PlatformRoleDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(PlatformRoleDto.fromJS(item));
            }
            else {
                result200 = null as any;
            }
        ...
        return _observableOf<PlatformRoleDto[]>(null as any);
    }
     ...
     * @return OK
     */
    create(body: CreatePlatformRoleRequest | undefined): Observable<PlatformRoleDto> {
        let url_ = this.baseUrl + "/api/PlatformRoles";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<PlatformRoleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PlatformRoleDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    getById(id: number): Observable<PlatformRoleDto> {
        let url_ = this.baseUrl + "/api/PlatformRoles/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetById(response: HttpResponseBase): Observable<PlatformRoleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(id: number, body: UpdatePlatformRoleRequest | undefined): Observable<PlatformRoleDto> {
        let url_ = this.baseUrl + "/api/PlatformRoles/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processUpdate(response: HttpResponseBase): Observable<PlatformRoleDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    assignPermissions(id: number, body: AssignPlatformPermissionsRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/PlatformRoles/{id}/permissions";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    removePermission(id: number, permId: number): Observable<void> {
        let url_ = this.baseUrl + "/api/PlatformRoles/{id}/permissions/{permId}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
...
export class TenantsClient {
    ...
    protected processGetById(response: HttpResponseBase): Observable<Tenant> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(id: number, body: UpdateTenantRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Tenants/{id}";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processGetAll(response: HttpResponseBase): Observable<TenantDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    create(body: CreateTenantRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Tenants";
        url_ = url_.replace(/[?&]$/, "");
...
export class AssignPlatformPermissionsRequest implements IAssignPlatformPermissionsRequest {
    permissionIds?: number[] | undefined;

    constructor(data?: IAssignPlatformPermissionsRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): AssignPlatformPermissionsRequest {
        data = typeof data === 'object' ? data : {};
        let result = new AssignPlatformPermissionsRequest();
        result.init(data);
        return result;
    }
...
export interface IAssignPlatformPermissionsRequest {
    permissionIds?: number[] | undefined;
}
...
export class CreatePlatformAdminRequest implements ICreatePlatformAdminRequest {
    email?: string | undefined;
    password?: string | undefined;
    displayName?: string | undefined;
    roleIds?: number[] | undefined;

    constructor(data?: ICreatePlatformAdminRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): CreatePlatformAdminRequest {
        data = typeof data === 'object' ? data : {};
        let result = new CreatePlatformAdminRequest();
        result.init(data);
        return result;
    }
...
export interface ICreatePlatformAdminRequest {
    email?: string | undefined;
    password?: string | undefined;
    displayName?: string | undefined;
    roleIds?: number[] | undefined;
...
export class CreatePlatformRoleRequest implements ICreatePlatformRoleRequest {
    roleName?: string | undefined;

    constructor(data?: ICreatePlatformRoleRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): CreatePlatformRoleRequest {
        data = typeof data === 'object' ? data : {};
        let result = new CreatePlatformRoleRequest();
        result.init(data);
        return result;
    }
...
export class PlatformAdminDetailDto implements IPlatformAdminDetailDto {
    ...
    createdAt?: Date;
    updatedAt?: Date;
    roles?: PlatformRoleDto[] | undefined;

    constructor(data?: IPlatformAdminDetailDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.platformAdminId = _data["platformAdminId"];
            this.email = _data["email"];
            this.displayName = _data["displayName"];
            ...
            if (Array.isArray(_data["roles"])) {
                ...
                for (let item of _data["roles"])
                    this.roles!.push(PlatformRoleDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PlatformAdminDetailDto {
        data = typeof data === 'object' ? data : {};
        let result = new PlatformAdminDetailDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["platformAdminId"] = this.platformAdminId;
        data["email"] = this.email;
        data["displayName"] = this.displayName;
...
export interface IPlatformAdminDetailDto {
    platformAdminId?: number;
    email?: string | undefined;
    displayName?: string | undefined;
    mustChangePassword?: boolean;
...
export class PlatformAdminDto implements IPlatformAdminDto {
    platformAdminId?: number;
    email?: string | undefined;
    displayName?: string | undefined;
    mustChangePassword?: boolean;
    ...
    constructor(data?: IPlatformAdminDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): PlatformAdminDto {
        data = typeof data === 'object' ? data : {};
        let result = new PlatformAdminDto();
        result.init(data);
        return result;
    }
...
export interface IPlatformAdminDto {
    platformAdminId?: number;
    email?: string | undefined;
    displayName?: string | undefined;
    mustChangePassword?: boolean;
...
export class PlatformRoleDto implements IPlatformRoleDto {
    ...
    constructor(data?: IPlatformRoleDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.platformRoleId = _data["platformRoleId"];
            this.roleName = _data["roleName"];
            this.isActive = _data["isActive"];
            this.createdAt = _data["createdAt"] ? new Date(_data["createdAt"].toString()) : undefined as any;
            this.permissionCount = _data["permissionCount"];
            this.adminCount = _data["adminCount"];
        }
    }

    static fromJS(data: any): PlatformRoleDto {
        data = typeof data === 'object' ? data : {};
        let result = new PlatformRoleDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["platformRoleId"] = this.platformRoleId;
        data["roleName"] = this.roleName;
        data["isActive"] = this.isActive;
        data["createdAt"] = this.createdAt ? this.createdAt.toISOString() : undefined as any;
...
export interface IPlatformRoleDto {
    platformRoleId?: number;
    roleName?: string | undefined;
    isActive?: boolean;
    createdAt?: Date;
...
export class UpdatePlatformAdminRequest implements IUpdatePlatformAdminRequest {
    ...
    constructor(data?: IUpdatePlatformAdminRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpdatePlatformAdminRequest {
        data = typeof data === 'object' ? data : {};
        let result = new UpdatePlatformAdminRequest();
        result.init(data);
        return result;
    }
...
export class UpdatePlatformRoleRequest implements IUpdatePlatformRoleRequest {
    roleName?: string | undefined;
    isActive?: boolean | undefined;

    constructor(data?: IUpdatePlatformRoleRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpdatePlatformRoleRequest {
        data = typeof data === 'object' ? data : {};
        let result = new UpdatePlatformRoleRequest();
        result.init(data);
        return result;
    }
