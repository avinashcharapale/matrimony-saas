...
export const TENANT_CONFIGS: TenantConfig[] = [
  {
    ...
    heroDescription:
      'Join the trusted matrimonial platform for Marathi communities with real profiles, astrology guidance, and simple enrollment.',
    heroImage:
    ...
    supportAddress: '203, 2nd Floor, Saras Plaza, Pune - 411030',
    copyrightText: '© 2026 Anand Maratha Marriage Bureau',
  ...
  },
  {
    ...
    heroDescription:
      'Bring your pets into a comprehensive care network with easy enrollment and on-demand support.',
    heroImage:
