            ...
            <form [formGroup]="form" (ngSubmit)="save()">
              <div class="dialog-body">
                <div class="field">
                  ...
                  <input formControlName="permissionCode" placeholder="e.g. user_create" />
                ...
                <div class="field">
                  ...
                  <input formControlName="displayName" placeholder="Create User" />
                ...
                <div class="field">
                  ...
                  <input formControlName="resourceType" placeholder="e.g. User" />
                </div>
                <div class="field">
                  <label>Action</label>
...
export class TenantPermissions implements OnInit {
  ...
  readonly deletingItem = signal<TenantPermissionDto | null>(null);
  readonly permissions = signal<TenantPermissionDto[]>([]);
  readonly searchTerm = signal('');
  readonly dialogOpen = signal(false);
  readonly deleteDialogOpen = signal(false);
  readonly editing = signal<TenantPermissionDto | null>(null);
  ...
  openDialog(perm?: TenantPermissionDto): void {
    if (perm) {
  ...
  save(): void {
    ...
    const request$ = edit?.permissionId
      ? this.service.update(tid, edit.permissionId, {
          displayName: val.displayName,
          description: val.description || undefined,
          isActive: val.isActive,
        })
      : this.service.create(tid, val);
