...
import { PlatformPermissionDto } from '../../../services/platform-permission.service';

export interface PermFormDialogData {
  mode: 'create' | 'edit';
  perm?: PlatformPermissionDto;
}
    ...
    <mat-dialog-content>
      <form [formGroup]="form">
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput formControlName="permissionCode" placeholder="e.g. manage_admins" />
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput formControlName="displayName" placeholder="Manage Admins" />
        ...
        <mat-form-field appearance="outline" class="full-width">
          ...
          <input matInput formControlName="resourceType" placeholder="e.g. Admin" />
        </mat-form-field>
